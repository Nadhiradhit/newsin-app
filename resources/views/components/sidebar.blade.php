...
<aside id="default-id" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 ">
    <div class="h-full px-3 py-4 overflow-y-auto bg-secondary">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ url('/dashboard/admin')}}" class="flex items-center p-2 text-white rounded-lg hover:bg-primary">
            ...
            <li>
                <a href="{{ route('admin.create') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-primary">
                    ...
                    <span class="ml-3">NewsIN</span>
                 </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-white rounded-lg hover:bg-primary">
